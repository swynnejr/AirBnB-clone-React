...
function Search({ searchResults }) {
    ...
    return (
        <div>
            <Header placeholder={`${range} | ${location} | ${noOfGuests} guests`} />

            <main className='flex'>
                <section className='flex-grow pt-14 px-6'>
                    <p className='text-xs'>300+ options {range} for { noOfGuests } guests</p>
...
// getServerSideProps(context) << Maybe later?
